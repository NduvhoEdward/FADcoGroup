...
export const metadata = {
  ...
  description: 'Top-rated architecture and construction company in South Africa. Expert residential and commercial design solutions. Registered with SACAP and NHBRC. Transform your vision into reality.',
...
const organizationSchema = {
  ...
  description: 'Professional architecture and construction services in South Africa',
  url: 'https://fadco.co.za',
  ...
  knowsAbout: ['Architectural Design', 'Construction Services', 'House Plans', 'Building Design', 'Residential Architecture'],
  priceRange: '$$',
  aggregateRating: {
...
export default function RootLayout({ children }) {
  ...
  const servicesSchema = {
    ...
    name: 'Fiya Architectural Designs and Construction',
    areaOfSpecialization: ['Architectural Design', 'Construction', 'Residential', 'Commercial']
  }
