            ...
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-400">
                  Fiya Architectural Designs
                </span>
              </div>
            </Link>
            <p className="text-gray-300 leading-relaxed">
              Giving your dreams a shape of reality. Proudly South African, we
              are architects of innovation and builders of excellence.
            </p>
            <div className="flex space-x-4">
              <Facebook
                size={20}
                className="text-gray-400 hover:text-accent-500 cursor-pointer transition-colors"
              />
              <Twitter
                size={20}
                className="text-gray-400 hover:text-accent-500 cursor-pointer transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300">
                Architectural Compliance (SACAP)
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} FADco - Fiya Architectural Designs
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-500 text-xs">
              ...
              <a
                href="https://selah.net.za"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-accent-500 transition-colors"
              >
                Selah Tech Solutions
              </a>
            </p>
          </div>
        </div>
